...
/**
 * XOOPS form compound elements decorator
 */

class Xoops_Zend_Form_Decorator_CompoundElements extends Zend_Form_Decorator_Abstract
{
    /**
    ...
    public function render($content)
    {
        ...
        if ((!$element instanceof Xoops_Zend_Form_Element_Compound)) {
            return $content;
        }
        ...
        foreach ($element as $item) {
            ...
            //Debug::e($form->getName().':'.get_class($item).':'.$item->render());
            $items[] = $item->render();
