...
class Xoops_Zend_Controller_Router_Route_Api extends Zend_Rest_Route
{
    /**
     * URI delimiter
     */
     ...
     * URI prefix
     */
    protected static $uri_prefix = 'api';
                ...
                Zend_Controller_Request_Abstract $request = null)
    {
        ...
        $this->_defaults[$this->_actionKey] = 'get';
        if (isset($request)) {
     ...
     *
     * The RESTful url structure: /api/moduleName/controllerName/action/[get|put|post|...]/...
     *
    ...
    public function match($path, $partial = false)
    {
        ...
        if (0 === strpos($path, self::$uri_prefix . '/')) {
            ...
            */
            ...
            if (empty($params[$this->_actionKey])) {
                $values[$this->_actionKey] = strtolower($this->_request->getMethod());
            }
        }
    ...
    {
        if (substr($string, 0, 3) != "xml" && substr($string, 0, 4) != "json") {
            return false;
        }
        return true;
    }
