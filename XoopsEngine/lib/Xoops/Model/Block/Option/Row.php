...
class Xoops_Model_Block_Option_Row extends Xoops_Zend_Db_Table_Row
{
    /**
    ...
    public function __get($columnName)
    {
        ...
        if ($columnName == "options" && !empty($value) && is_string($value)) {
            $value = unserialize($value);
            return $value;
        }
        if ($columnName != "value") {
    ...
    protected function filterInput()
    {
        ...
        if (isset($this->_modifiedFields["options"]) && !empty($this->_data["options"])) {
            $this->_data["options"] = serialize($this->_data["options"]);
        }
    }
}
