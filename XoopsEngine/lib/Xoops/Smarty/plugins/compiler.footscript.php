...
/**
 * Inserts a footScript element
 * @see Xoops_Zend_View_Helper_FootScript
 *
 * <code>
 * <{footScript src='src' source='source' placement='append' type='text/javascript' defer=defer charset=utf-8 language=en-US}>
 * </code>
 */


class Smarty_Compiler_FootScript  extends Smarty_Internal_CompileBase
{
    /**
     * Compiles code for the {footScript} tag
     *
    ...
    public function compile($args, $compiler)
    {
        ...
        $str = "XOOPS::registry(\"view\")->footScript({$mode}, {$spec}, {$placement}";
        $str .= ", ";
