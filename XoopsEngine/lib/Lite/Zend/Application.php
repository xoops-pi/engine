...
class Lite_Zend_Application extends Zend_Application
{
    protected $engine;
    ...
    public function setOptions(array $options)
    {
        ...
        if (!empty($options['bootstrap'])) {
            ...
            if (is_string($bootstrap)) {
                $bootstrap['path'] = XOOPS::path("lib") . "/Lite/Zend/Application/Bootstrap/" . ucfirst($bootstrap) . ".php";
                $bootstrap['class'] = "Lite_Zend_Application_Bootstrap_" . ucfirst($bootstrap);
            } elseif (is_array($bootstrap)) {
                if (empty($bootstrap['path']) && !empty($bootstrap['class'])) {
                    $bootstrap['path'] = XOOPS::path("lib") . "/Lite/Zend/Application/Bootstrap/" . ucfirst($bootstrap['class']) . ".php";
                    $bootstrap['class'] = "Lite_Zend_Application_Bootstrap_" . ucfirst($bootstrap['class']);
                }
            }
        ...
        $options_default = array(
            "bootstrap" => array(
                "path"  => XOOPS::path("lib") . "/Lite/Zend/Application/Bootstrap/Bootstrap.php",
    ...
    public function loadBootstrap($name = null)
    {
        if (empty($name)) {
            ...
            $class = 'Lite_Zend_Application_Bootstrap_' . $name;
        }
