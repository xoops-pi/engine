<?php
/**
 * CKFinder config for Xoops Engine
 *
...
{
    if (!\Xoops::service('session')->ckfinder->role) return false;
    $_SESSION['CKFinder_UserRole'] = \Xoops::service('session')->ckfinder->role;
    return true;
...
$baseUrl = Xoops::url('upload') . $finderFolder;
...
*/
//$baseDir = resolveUrl($baseUrl);
$baseDir = Xoops::path('upload') . $finderFolder;
