...
define("_INSTALL_LANGUAGE_LABEL", "Language");
define("_INSTALL_LANGUAGE_DESC", "Choose the language for the installation and website");

define("_INSTALL_CHECK_SEVERSETTINGS", "Sever setting detection");

// Settings (labels and help text)

define("_INSTALL_ROOT_PATH_LABEL", "Documents root physical path");
define("_INSTALL_ROOT_PATH_HELP", "Physical path to the documents (served) directory without trailing slash");

define("_INSTALL_URL_LABEL", "Website location (URL)"); // L56
define("_INSTALL_URL_HELP", "Main URL that will be used to access your XOOPS installation"); // L58

define("_INSTALL_LIB_PATH_LABEL", "Library directory");
define("_INSTALL_LIB_PATH_HELP", "Physical path to library directory without trailing slash. Locate the folder out of " . _INSTALL_ROOT_PATH_LABEL . " to make it secure.");

define("_INSTALL_DATA_PATH_LABEL", "Data file directory");
define("_INSTALL_DATA_PATH_HELP", "Physical path to the data files (writable) directory WITHOUT trailing slash. Locate the folder out of " . _INSTALL_ROOT_PATH_LABEL . " to make it secure.");

define("_INSTALL_USR_PATH_LABEL", "Basic directory for user applications");
define("_INSTALL_USR_PATH_HELP", "Physical path to user application directory WITHOUT trailing slash. Locate the folder out of " . _INSTALL_ROOT_PATH_LABEL . " to make it secure.");

define("_INSTALL_APP_PATH_LABEL", "Application module directory");
define("_INSTALL_APP_PATH_HELP", "Physical path to application module directory without trailing slash.");

define("_INSTALL_APP_URL_LABEL", "URL of application root directory");
define("_INSTALL_APP_URL_HELP", "URL that will be used to access application directory. For security consideration, it is highly recommended to leave it blank.");

define("_INSTALL_PLUGIN_PATH_LABEL", "Plugin directory");
define("_INSTALL_PLUGIN_PATH_HELP", "Physical path to plugin directory without trailing slash.");

define("_INSTALL_PLUGIN_URL_LABEL", "URL of plugin root directory");
define("_INSTALL_PLUGIN_URL_HELP", "URL that will be used to access plugin directory. For security consideration, it is highly recommended to leave it blank.");

define("_INSTALL_APPLET_PATH_LABEL", "Applet directory");
define("_INSTALL_APPLET_PATH_HELP", "Physical path to applet directory without trailing slash.");

define("_INSTALL_APPLET_URL_LABEL", "URL of applet root directory");
define("_INSTALL_APPLET_URL_HELP", "URL that will be used to access applet directory. For security consideration, it is highly recommended to leave it blank.");

define("_INSTALL_UPLOAD_PATH_LABEL", "Upload directory");
define("_INSTALL_UPLOAD_PATH_HELP", "Physical path to upload directory without trailing slash. A relative path will be allocated in XOOPS root directory");

define("_INSTALL_UPLOAD_URL_LABEL", "URL of upload root");
define("_INSTALL_UPLOAD_URL_HELP", "URL that will be used to access upload directory. A relative URL will be appended to XOOPS root URL.");

define("_INSTALL_IMG_PATH_LABEL", "Static file directory");
define("_INSTALL_IMG_PATH_HELP", "Physical path to static file directory without trailing slash. Upload directory will be used if not set explicitly.");

define("_INSTALL_IMG_URL_LABEL", "URL of static file root directory");
define("_INSTALL_IMG_URL_HELP", "URL that will be used to access static files. Upload URL will be used if static directory is not set explicitly.");

define("_INSTALL_THEME_PATH_LABEL", "Theme directory");
define("_INSTALL_THEME_PATH_HELP", "Physical path to theme directory without trailing slash. 'themes' in img will be used if not set explicitly.");

define("_INSTALL_THEME_URL_LABEL", "URL of theme root directory");
define("_INSTALL_THEME_URL_HELP", "URL that will be used to access themes. 'themes' in img will be used if not set explicitly.");


define("_INSTALL_LEGEND_CONNECTION", "Server connection");
define("_INSTALL_LEGEND_DATABASE", "Database");
...
define("_INSTALL_ADMIN_LOGIN_LABEL", "Admin login");
define("_INSTALL_ADMIN_EMAIL_LABEL", "Admin email");
define("_INSTALL_ADMIN_PASS_LABEL", "Admin password");
define("_INSTALL_ADMIN_CONFIRMPASS_LABEL", "Confirm password");
...
define("_INSTALL_ERR_WRITE_CONFIGFILE", "The configuration file '%s' is not written correctly.");
...
define("_INSTALL_ERR_COPY_CONFIGFILES", "The configuration files are not copied correctly or not readable, please create and/or set read permissions for the files manually.");
