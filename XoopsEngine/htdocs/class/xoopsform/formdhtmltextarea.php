...
class XoopsFormDhtmlTextArea extends XoopsFormTextArea
{
     ...
     *          <li><ul>Set up custom configs: in XOOPS_VAR_PATH . '/etc/xoopsconfig.php' set a editor as default, e.g.
    ...
    function XoopsFormDhtmlTextArea($caption, $name, $value = "", $rows = 5, $cols = 50, $hiddentext = "xoopsHiddenText", $options = array() )
    {
        ...
        if (!isset($options['editor'])) {
            $configs =@ include Xoops::path( "var/etc/xoopsconfig.php" );
    ...
    function render()
    {
        ...
        // the textarea box
        $ret .= "<textarea  " . ($this->getDisabled() ? "disabled " : "") . "id='" . $this->getName() . "' name='" . $this->getName() . "' onselect=\"xoopsSavePosition('" . $this->getName() . "');\" onclick=\"xoopsSavePosition('" . $this->getName() . "');\" onkeyup=\"xoopsSavePosition('" . $this->getName() . "');\" cols='" . $this->getCols() . "' rows='" . $this->getRows() . "'" . $this->getExtra() . ">" . $this->getValue() . "</textarea><br />\n";
        ...
        if (empty($this->skipPreview)) {
            ...
            $button = //"<br />" .
                    "<input  " . ($this->getDisabled() ? "disabled " : "") .
