<?php
/**
 * Generic module admin page controller
 *
...
class Module_PageController extends Xoops_Zend_Controller_Action_Admin
{
    // page list
    public function indexAction()
    {
        $this->setTemplate("system/admin/page_list_module.html");
        ...
        $title = sprintf(XOOPS::_("Pages of module %s"), $modules[$module]["name"]);
        ...
        $this->template->assign("dirname", $module);
    }
    ...
    public function insertAction()
    {
        ...
        //$positions = self::getBlockPositions();
    ...
    public function saveAction()
    {
        ...
        $redirect = array("action" => "index", "section" => $section);
        $this->redirect($redirect, $options);
    }
    ...
    private function getFormBlocks($name, $blocks, $title, $action, $page)
    {
        ...
        $blockPositions = self::getBlockPositions();
        $form = new XoopsThemeForm($title, $name, $action, 'post', true);
