...
class XoopsFormPassword extends XoopsFormElement
{
    ...
    function render()
    {
        ...
        return "<input  " . ($this->getDisabled() ? "disabled " : "") . "type='password' name='{$ele_name}' id='{$ele_name}' size='" . $this->getSize() . "' maxlength='" . $this->getMaxlength() . "' value='" . $this->getValue() . "'" . $this->getExtra() . " " . ($this->autoComplete ? "" : "autocomplete='off' ") . "/>";
    }
}
?>