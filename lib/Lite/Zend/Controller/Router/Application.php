...
class Lite_Zend_Controller_Router_Application extends Zend_Controller_Router_Rewrite
{
    ...
    public function __construct(array $params = array())
    {
        ...
        $configs = XOOPS::loadConfig("routes." . XOOPS::config("identifier") . ".ini");
        //Debug::e($configs);
        if (!empty($configs)) {
    ...
    public function loadRoute($name)
    {
        ...
        if (!isset($this->_routes[$name]) && !isset($configIsLoaded)) {
            $configs = XOOPS::loadConfig("routes.ini");
            //Debug::e($configs);
            if (!empty($configs)) {
                $configs = new Zend_Config($configs);
                $this->addConfig($configs);
